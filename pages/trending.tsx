...
const movies = [
  ...
  },
  {
    ...
    description:
      'The presidencies of Kennedy and Johnson, the Vietnam War, and the Watergate scandal are seen through the eyes of a simple-minded but kind-hearted and athletically-talented man.',
  },
  {
    title: 'Inception',
...
export default function Trending() {
  return (
    <>
      ...
      <Catalogue
        items={movies}
        moduleName={ModuleName.Trending}
